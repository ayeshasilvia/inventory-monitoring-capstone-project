...
def create_data_loaders(data, batch_size, loader_type):
    '''
...
def main(args):
    train_loader = create_data_loaders(os.environ['SM_CHANNEL_TRAIN'], args.batch_size, 'train')
    validation_loader = create_data_loaders(os.environ['SM_CHANNEL_VALID'], args.batch_size, 'valid')
    test_loader = create_data_loaders(os.environ['SM_CHANNEL_TEST'], args.test_batch_size, 'test')
    '''
    ...
    '''
    torch.save(model, 'binImages_resnet50_hpo.pt')
